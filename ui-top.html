...
<div class="panel panel-sidebar" @contextmenu.prevent>
    ...
    <div v-if="contextMenu.showImageDialog && contextMenu.dialogImage" class="image-dialog" :style="imageDialogStyles">
        <div class="image-dialog-content">
            ...
            <div class="image-dialog-image">
                <img :src="contextMenu.dialogImage.base64Data" :style="dialogImageStyles" @click.stop="handleImageClick($event)">
            </div>
